...
export const metadata: Metadata = {
  title: "Toy Locker, LLC | 404: Page Not Found",
  description: "Toy Locker, LLC 404 Error Page",
  // other metadata
};
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <h3 className="dark:text-white mb-4 text-3xl font-bold text-black sm:text-4xl">
