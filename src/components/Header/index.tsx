              ...
              >
                <ul className="block lg:flex lg:space-x-12">
                  {menuData.map((menuItem, index) => (
                    <li key={index} className="group relative">
                      {menuItem.path ? (
                        menuItem.path.startsWith("tel:") ? (
                          <a
                            href={menuItem.path}
                            className="dark:text-white/70 dark:hover:text-white flex py-2 text-base text-dark hover:text-primary lg:mr-0 lg:inline-flex lg:px-0 lg:py-6"
                          >
                            {menuItem.title}
                          </a>
                        ) : (
                ...
                <div className="flex flex-col">
                  <a
                    ...
                    className="ease-in-up rounded-sm bg-primary px-8 py-3 text-base font-medium text-white shadow-btn transition duration-300 hover:bg-opacity-90 hover:shadow-btn-hover md:hidden md:px-9 lg:px-6 xl:px-9"
                  >
                    Tenant Portal
                  </a>
                </div>
