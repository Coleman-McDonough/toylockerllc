    ...
    <>
      <footer className="dark:bg-gray-dark relative z-10 bg-white pt-16 md:pt-20 lg:pt-24">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="mt-3 flex items-center">
                  ...
                  <a
                    href="https://www.youtube.com/@cpmcdonoughconstructioncor3107"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="dark:text-body-color-dark dark:hover:text-primary mr-6 text-body-color duration-300 hover:text-primary"
                  ...
                  <a
                    href="https://www.linkedin.com/in/coleman-mcdonough-4702861aa/"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-6 lg:mb-12">
                <h2 className="dark:text-white mb-5 text-xl font-bold text-black">
                  Toy Locker
                </h2>
                <ul>
                  <li>
          ...
          <div className="dark:via-[#063646] h-px w-full bg-gradient-to-r from-transparent via-[#063646] to-transparent"></div>
          <div className="pb-8">
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#063646" />
            <mask
              id="mask0_94:899"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#063646" stopOpacity="0.62" />
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#063646" stopOpacity="0" />
                <stop offset="1" stopColor="#063646" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
