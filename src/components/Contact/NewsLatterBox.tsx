...
const NewsLatterBox = () => {
  ...
  return (
    <div className="dark:bg-gray-dark relative z-10 rounded-sm bg-white p-8 shadow-three sm:p-11 lg:p-8 xl:p-11">
      <h3 className="dark:text-white mb-4 text-2xl font-bold leading-tight text-black">
        Subscribe To Keep Updated
      </h3>
      <p className="dark:border-white dark:border-opacity-25 mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color">
        Stay updated with Toy Locker&apos;s latest news and offers.
      </p>
      <div>
        <input
          type="text"
          ...
          className="border-stroke dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90"
        />
      </div>
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#063646" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
